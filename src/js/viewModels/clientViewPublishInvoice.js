 ...
 "use strict";
    class PublishViewModel {
            ...
            function getApprovedTimesheet() {    
                ...
                $.ajax({
                 ...
                 if (result[4] !== 'null') {
                    ...
                    if(dataInvoice[16]=='Paid'){
                        // document.getElementById('mainView').style.display='none';  
                        // document.getElementById('contentView').style.display='none';
                        // document.getElementById('invoiceDateSec').style.display='none';
                    ...
                    self.client_pay_status(dataInvoice[16])
        ...
        //    docprint.focus(); 
                ...
                document.querySelector('#openInvoicePaidProgress').open();  
                console.log(self.timesheetIdList())
                var resultString = self.timesheetIdList().join(',');
                $.ajax({
                    url: BaseURL + "/jpClientPayNotify",
                    type: 'POST',
                    data: JSON.stringify({
                        invoiceId : sessionStorage.getItem("invoiceId"),
